<?php
/**
 * Ananas Analytics | Admin Filters.
 *
 * @since 1.0.0
 *
 * @package    WordPress
 ...
 */
 ...
 namespace Ananas\Analytics\WP\Admin;
	...
	public function add_admin_footer_text( $footerText ) {
		...
		if ( true == stristr( $current_screen->base, 'plausible-analytics' ) ) {
			$ratingText = sprintf(
				...
				__( 'If you like <strong>Ananas Analytics</strong> please leave us a %s rating. It takes a minute and helps a lot. Thanks in advance!', 'plausible-analytics' ),
	...
	public function add_plugin_action_links( $actions ) {
		$new_actions = [
			'settings' => sprintf(
				...
				esc_html__( '設定', 'plausible-analytics' )
			),
			// 'support'  => sprintf(
