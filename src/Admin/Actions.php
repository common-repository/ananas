<?php
/**
 * Ananas Analytics | Admin Actions.
 *
 * @since 1.0.0
 *
 * @package    WordPress
...
class Actions {
	...
	public function save_admin_settings() {
		...
		$post_setting_data = sanitize_text_field( wp_unslash( $_POST['plausible_analytics_settings'] ) );
		...
		$new_settings = wp_parse_args( $post_setting_data, $settings );
